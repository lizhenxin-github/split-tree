...
public:
    ...
    int64_t num_actual_keys;
    int64_t num_total_keys;
...
#ifdef SPLIT_EVALUATION
                hist_set->Add(DO_SPLIT_BY_SELF, ElapsedNanos(time_start));
#endif
                return;
            }
